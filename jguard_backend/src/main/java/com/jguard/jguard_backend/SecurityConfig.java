...
import com.jguard.jguard_backend.jwt.*;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests((auth) -> auth
                        ...
                        .requestMatchers(new AntPathRequestMatcher("/api/trend")).permitAll() // 트렌드 (로그인 필요)
                        .requestMatchers(new AntPathRequestMatcher("/api/news")).permitAll()  // 뉴스 (로그인 필요)

                        // 인증된 사용자만 접근 허용하는 경로들
                        .requestMatchers(new AntPathRequestMatcher("/api/question/modify/**")).authenticated()
                        .requestMatchers(new AntPathRequestMatcher("/api/question/delete/**")).authenticated()
                        .requestMatchers(new AntPathRequestMatcher("/api/answer/create/**")).authenticated()
                        .requestMatchers(new AntPathRequestMatcher("/api/question/create")).authenticated()
                        .requestMatchers(new AntPathRequestMatcher("/api/user/me")).authenticated()
                        .requestMatchers(new AntPathRequestMatcher("/api/questions")).permitAll() // ⭐ 게시판 API (로그인 필요)
